...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$etiqueta = limpiarDatos($_POST['etiqueta']);
	...
	$statement = $conexion->prepare('UPDATE articulos SET titulo = :titulo, extracto = :extracto, texto = :texto, thumb = :thumb, etiqueta = :etiqueta, telefono = :telefono, correo = :correo WHERE id = :id');
